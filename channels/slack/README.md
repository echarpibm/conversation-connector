...
- Use [the Conversation tool](https://console.bluemix.net/docs/services/conversation/conversation-connector.html#deploying-to-slack-using-the-watson-assistant-tool) if you want to quickly deploy your app with just a few clicks.
